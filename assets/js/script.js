...
let testemonials = [
    ...
    {quote:'"CakeCar é um serviço de entrega direto ao '+ 
        'consumidor, utilizamos os produtos mais'+
        'renomados do mercado!"',
        origin:'forbes.svg' }, 
    {quote:'"CakeCar usa produtos confiaveis e de qualidade'+ 
        'extrema."', origin:'fox.svg' }, 
    {quote:'"Vejo você CakeCar como um verdadeiro herói"',
